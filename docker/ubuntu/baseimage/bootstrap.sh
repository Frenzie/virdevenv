...
MISC_TOOLS="sudo git subversion zip unzip vim wget p7zip-full bash-completion"
...
# build-essential depends on gcc 5.4 which apparently won't be installed
# combined in one statement with gcc-4.8
